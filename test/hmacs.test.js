esquire(['bletchley/hmacs', 'bletchley/codecs', 'bletchley/utils/arrays'], function(hmacs, codecs, arrays) {
  ...
  describe("HMACs", function() {
    ...
    it("should exist", function() {
      ...
      expect(hmacs).to.be.a('object');
      expect(hmacs).to.be.a('object');
      expect(hmacs.hmac).to.be.a('function');
      expect(hmacs.algorithms).to.include("SHA1");
      expect(hmacs.algorithms).to.include("SHA-224");
      expect(hmacs.algorithms).to.include("SHA-256");
      expect(hmacs.algorithms).to.include("SHA-384");
      expect(hmacs.algorithms).to.include("SHA-512");
    });
