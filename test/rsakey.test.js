...
Esquire.define('test/RSAKey', [ 'bletchley/keys/RSAKey',
                                'bletchley/keys/RSAKeyFactory',
                                'bletchley/utils/BigInteger',
                                'bletchley/random/SecureRandom',
                                'bletchley/codecs'],
  function(RSAKey, RSAKeyFactory, BigInteger, SecureRandom, codecs) {
    ...
    return function() {
      ...
      describe("RSA Keys", function() {
        ...
        it('should generate a simple 1024 bits key', function() {
          var key = new RSAKeyFactory(random).generateKey(1024);
        ...
        it('should generate a simple 512 bits key with 3 as public exponent', function() {
          var key = new RSAKeyFactory(random).generateKey(512, { e: 3 });
