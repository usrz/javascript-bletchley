Esquire.define('bletchley/hashes/Hashes', [ 'bletchley/utils/helpers',
  ...
  function(helpers, SHA1, SHA224, SHA256, SHA384, SHA512) {
    ...
    Hashes.prototype = Object.create(helpers.Factory.prototype);
