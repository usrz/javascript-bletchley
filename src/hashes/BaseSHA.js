...
Esquire.define('bletchley/hashes/BaseSHA', [ 'bletchley/hashes/Hash' ],

  function(Hash) {

    function BaseSHA(buffSize, digestSize, lenBytes) {
      ...
      Hash.call(this, buffSize, digestSize);
    }

    /* BaseSHA extends Hash */
    return Hash.$super(BaseSHA);
