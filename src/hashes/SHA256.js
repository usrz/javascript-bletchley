...
Esquire.define('bletchley/hashes/SHA256', [ 'bletchley/hashes/BaseSHA',
  ...
  function(BaseSHA, arrays) {
    ...
    function SHA256(digestSize, h) {
      ...
      /* Super constructor */
      BaseSHA.call(this, BLOCK_SIZE, digestSize || DIGEST_SIZE, LEN_BYTES);
    };

    /* SHA256 extends BaseSHA */
    return BaseSHA.$super(SHA256);
