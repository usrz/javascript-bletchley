...
Esquire.define('bletchley/hashes/HashSHA256', ['bletchley/hashes/Hash', 'bletchley/utils/extend'], function(Hash, extend) {
  ...
  function compute(message, output, h0, h1, h2, h3, h4, h5, h6, h7) {
    ...
    /* Copy the message */
    new Uint8Array(expanded).set(message);
 ...
 return extend(function(name, digestSize, h) {
    ...
    Hash.call(this, name, 64, digestSize, function(message, output) {
      return compute.call(this, message, output, h0, h1, h2, h3, h4, h5, h6, h7);
    });
