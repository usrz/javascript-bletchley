...
Esquire.define('bletchley/hashes/SHA1', ['bletchley/hashes/BaseSHA', 'bletchley/utils/arrays'], function(BaseSHA, arrays) {
  ...
  function SHA1() {
    ...
    /* Super constructor */
    BaseSHA.call(this, "SHA1", BLOCK_SIZE, DIGEST_SIZE, LEN_BYTES);
  };

  SHA1.prototype = Object.create(BaseSHA.prototype);
