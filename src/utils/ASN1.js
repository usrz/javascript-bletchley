...
Esquire.define('bletchley/utils/ASN1', [], function() {
  ...
  /* ======================================================================== *
   | Local extension and Exquire exports                                      |
   * ======================================================================== */

  ASN1.prototype.toUint8Array = function (array) {
      ...
      var end = this.posEnd();
      for (var pos = 0, i = this.posContent(); i < end; pos++, i ++) {
        array[pos] = this.stream.get(i);
      }
